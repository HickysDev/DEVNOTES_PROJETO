Fazendo o uso de JavaScript o site cria notas onde você pode fixar, duplicar ou excluir utilizando local storage. O projeto possui uma barra de pesquisa e um botão para você baixar as notas como csv.
